...
if (saved == 1)
{
    if instance_exists(obj_pl_dynamite1)
    {
        with (obj_pl_dynamite1)
        {
            instance_create(x, y, obj_pl_dynamite_saved)
            instance_destroy()
        }
    }
    if instance_exists(obj_pl_dynamite2)
    {
        with (obj_pl_dynamite2)
        {
            instance_create(x, y, obj_pl_dynamite_saved)
            instance_destroy()
        }
    }
    if instance_exists(obj_pl_boom)
    {
        with (obj_pl_boom)
            instance_destroy()
    }
