...
{
    draw_sprite(spr_merc_battle, 4, x, (y - (shaking / 4)))
...
{
    draw_sprite_ext(spr_merc_battle, 4, x, y, 1, 1, 0, image_blend, 0.5)
    ...
    draw_sprite_ext(spr_merc_battle, 0, x, y, 1, 1, 0, image_blend, 0.5)
}
...
if (enemydead == 1)
{
    draw_sprite_ext(spr_merc_battle, 4, x, y, 1, 1, 0, image_blend, image_alpha)
    ...
    draw_sprite_ext(spr_merc_battle, 0, x, y, 1, 1, 0, image_blend, image_alpha)
}
