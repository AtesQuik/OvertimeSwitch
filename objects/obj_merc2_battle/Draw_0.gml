...
{
    draw_sprite(spr_merc_battle, 11, x, (y - (shaking / 4)))
    ...
    draw_sprite(spr_merc_battle, 9, x, (y - (shaking / 6)))
}
if (enemyhurt == 1 && enemydead == 0)
{
    draw_sprite_ext(spr_merc_battle, 11, x, y, 1, 1, 0, image_blend, 0.5)
    ...
    draw_sprite_ext(spr_merc_battle, 9, x, y, 1, 1, 0, image_blend, 0.5)
}
...
if (enemydead == 1)
{
    draw_sprite_ext(spr_merc_battle, 11, x, y, 1, 1, 0, image_blend, image_alpha)
    ...
    draw_sprite_ext(spr_merc_battle, 9, x, y, 1, 1, 0, image_blend, image_alpha)
}
