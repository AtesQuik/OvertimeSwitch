...
if (timetochoose == 1)
{
    ...
    {
        if (selected == 0)
            draw_sprite(spr_soul_small, 0, (__view_get( e__VW.XView, (0 << 0) ) + 93), (__view_get( e__VW.YView, (0 << 0) ) + 214))
        if (selected == 1)
            draw_sprite(spr_soul_small, 0, (__view_get( e__VW.XView, (0 << 0) ) + 189), (__view_get( e__VW.YView, (0 << 0) ) + 214))
    }
    else
    {
        if (selected == 0)
            draw_sprite(spr_soul_small, 0, (__view_get( e__VW.XView, (0 << 0) ) + 93), (__view_get( e__VW.YView, (0 << 0) ) + 58))
        if (selected == 1)
            draw_sprite(spr_soul_small, 0, (__view_get( e__VW.XView, (0 << 0) ) + 189), (__view_get( e__VW.YView, (0 << 0) ) + 58))
    }
}
